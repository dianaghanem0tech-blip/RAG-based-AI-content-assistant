...
The application retrieves relevant content based on semantic similarity and uses Ollama to generate answers only from approved sources. It supports multiple task types, including normal answers, quiz questions, assignment guidance, lesson summaries, learning activities, and short explanations.
